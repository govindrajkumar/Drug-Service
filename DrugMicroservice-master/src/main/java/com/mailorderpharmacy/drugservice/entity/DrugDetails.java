...
public class DrugDetails {
	...
	public DrugDetails(final String drugId, final String drugName, final String manufacturer,
			final Date manufactureDate, final Date expiryDate, final List<DrugLocationDetails> druglocationQuantities) {
		this.druglocationQuantities = new ArrayList<DrugLocationDetails>();
		this.drugId = drugId;
		this.drugName = drugName;
		this.manufacturer = manufacturer;

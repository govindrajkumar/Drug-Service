...
//http://localhost:8081/drugdetailapp/
@RestController
...
public class DrugController {
	...
	public DrugDetails getDrugById(@RequestHeader("Authorization") final String token,
			@PathVariable("id") final String id) throws InvalidTokenException, DrugNotFoundException {
	...
	public DrugDetails getDrugByName(@RequestHeader("Authorization") final String token,
			@PathVariable("name") final String name) throws InvalidTokenException, DrugNotFoundException {
	...
	public Stock getDispatchableDrugStock(@RequestHeader("Authorization") final String token,
			@PathVariable("id") final String id, @PathVariable("location") final String location)
	...
	public ResponseEntity<SuccessResponse> updateQuantity(@RequestHeader("Authorization") final String token,
			@PathVariable("id") final String id, @PathVariable("location") final String location,
